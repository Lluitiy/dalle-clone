...
const CreatePost = () => {
		...
		if (form.prompt) {
			try {
				...
				const response = await fetch(
					"https://dalle-clone-4kci.onrender.com/api/v1/dalle",
					{
						method: "POST",
	...
	const handleSubmit = async (e) => {
		...
		if (form.prompt && form.photo) {
			...
			try {
				const response = await fetch(
					"https://dalle-clone-4kci.onrender.com/api/v1/post",
					{
						method: "POST",
						headers: {
		...
		<section className="max-w-7xl mx-auto">
			<div>
				...
				<p className="mt-2 text-[#666e75] text-[16px] max-w[500px]">
					Create imaginative and stunning images through DALL-E AI and
			...
			<form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
				<div className="flex flex-col gap-5">
					...
					<FormField
						...
						type="text"
						name="prompt"
						placeholder="Worm man eater in form of Rubicks Cube"
						value={form.prompt}
						handleChange={handleChange}
						isSurpriseMe
